      ...
      <div className="bg-dark-surface border-b border-dark-border">
        <div className="container-custom py-4">
          <div className="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <span>/</span>
            <span className="text-gray-300">Emergency Roof Repair</span>
          </div>
        </div>
      </div>
          ...
          <div className="max-w-3xl mx-auto card bg-yellow-500/5 border-yellow-500">
            <ol className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-300">Safety first - If water is near electrical, turn off power to that area</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="font-bold text-yellow-500">2.</span>
                <span className="text-gray-300">Place buckets under active leaks</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="font-bold text-yellow-500">3.</span>
                <span className="text-gray-300">Move valuables away from leak areas</span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="font-bold text-yellow-500">4.</span>
                <span className="text-gray-300">Take photos of damage (interior and visible exterior)</span>
              </li>
              <li className="flex items-start space-x-3">
      ...
      <section className="section-padding bg-dark-bg">
        <div className="container-custom">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-400 mb-6 text-center">Text photos to 913-396-3717. Include:</p>
        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <p className="text-gray-400 text-sm mb-4">Stop or slow active water intrusion:</p>
              <ul className="space-y-2 text-sm text-gray-400">
            ...
            <div className="card">
              ...
              <p className="text-gray-400 text-sm mb-4">Once assessed and approved:</p>
              <ul className="space-y-2 text-sm text-gray-400">

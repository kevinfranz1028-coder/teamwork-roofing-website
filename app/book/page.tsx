      ...
      <section className="section-padding bg-light-bg">
        <div className="container-custom max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <div className="inline-flex items-center space-x-2 bg-teamwork-green/10 border border-teamwork-green px-4 py-2 rounded-lg">
              <FiClock className="w-5 h-5 text-teamwork-green" />
              <span className="text-teamwork-green font-semibold">Same-Week Promise</span>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <div className="w-8 h-8 rounded-full bg-teamwork-green/10 flex items-center justify-center flex-shrink-0">
                      <span className="text-teamwork-green font-bold">1</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-8 h-8 rounded-full bg-teamwork-green/10 flex items-center justify-center flex-shrink-0">
                      <span className="text-teamwork-green font-bold">2</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-8 h-8 rounded-full bg-teamwork-green/10 flex items-center justify-center flex-shrink-0">
                      <span className="text-teamwork-green font-bold">3</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-8 h-8 rounded-full bg-teamwork-green/10 flex items-center justify-center flex-shrink-0">
                      <span className="text-teamwork-green font-bold">4</span>
                    </div>
                    <div>
              ...
              <div className="card bg-gradient-to-br from-teamwork-green to-green-700">
                ...
                <a href="tel:9133963717" className="btn-primary bg-white text-teamwork-green hover:bg-gray-100 w-full text-center block">
                  Call 913-396-3717
                </a>
              </div>
              ...
              <div className="card">
                <h4 className="font-semibold mb-2 flex items-center">
                  <FiCheckCircle className="w-5 h-5 text-teamwork-green mr-2" />
                  Have photos?
                </h4>
                <p className="text-sm text-text-secondary">
                  Text photos to <a href="sms:9133963717" className="text-teamwork-green hover:underline">913-396-3717</a> or email them after booking
                </p>
              </div>
            </div>
          </div>

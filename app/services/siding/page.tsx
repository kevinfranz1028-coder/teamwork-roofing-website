      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card"><h3 className="heading-4 mb-2">Vinyl</h3><p className="text-text-secondary">Low maintenance, affordable, wide color selection</p></div>
            <div className="card"><h3 className="heading-4 mb-2">Fiber Cement</h3><p className="text-text-secondary">Durable, fire-resistant, premium appearance</p></div>
            <div className="card"><h3 className="heading-4 mb-2">Wood & Composite</h3><p className="text-text-secondary">Natural beauty, classic appeal</p></div>
          </div>
        </div>
      </section>

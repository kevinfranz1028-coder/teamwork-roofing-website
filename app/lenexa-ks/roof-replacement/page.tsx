...
export const metadata = {
  title: 'Roof Replacement Lenexa, KS | Warranty + Clean Site | Teamwork',
  description: 'Professional roof replacement in Lenexa. Photo-proof inspection, clean site guarantee, financing, Teamwork Warranty. Same-week inspections.',
}

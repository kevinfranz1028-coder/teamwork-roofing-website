...
export const metadata = {
  title: 'Roof Repair Lenexa, KS | Same-Week Inspections | Teamwork',
  description: 'Fast, professional roof repair in Lenexa. Same-week inspections, photo-proof documentation, honest repair vs replace guidance. Call 913-396-3717',
}

const cityData = cities['lenexa-ks']

export default function LenexaRoofRepairPage() {

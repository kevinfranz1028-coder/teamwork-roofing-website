...
export const metadata = {
  title: 'Lenexa Roofing Company | Teamwork Roofing Services',
  description: 'Teamwork Roofing Services provides roofing, gutters, siding, and windows in Lenexa, KS. Same-week inspections, photo-proof documentation, clean job sites, financing, and a Teamwork Warranty.',
}
...
export default function LenexaPage() {
  const services = [
    { icon: FiTool, title: 'Roof Repair', href: '/lenexa-ks/roof-repair/' },
    { icon: FiHome, title: 'Roof Replacement', href: '/lenexa-ks/roof-replacement/' },

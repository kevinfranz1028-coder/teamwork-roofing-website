...
export const metadata = {
  title: 'Roofing Companies Lenexa, KS | How to Compare | Teamwork',
  description: 'Choosing between roofing companies in Lenexa? Learn how to compare quotes apples-to-apples, spot red flags, and select the right partner.',
}

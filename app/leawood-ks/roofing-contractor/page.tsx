...
export const metadata = {
  title: 'Roofing Contractor Leawood, KS | Warranty + Financing | Teamwork',
  description: 'Your Leawood roofing contractor built on partnership. Same-week inspections, photo-proof documentation, clean site guarantee, financing, warranty.',
}

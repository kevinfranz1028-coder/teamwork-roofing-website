    ...
    <section className="section-padding bg-dark-bg">
      <div className="container-custom max-w-4xl">
        ...
        <div className="space-y-6 text-gray-400">
          ...
          <div>
            <h2 className="heading-4 text-white mb-3">Agreement to Terms</h2>
            <p>
          ...
          <div>
            <h2 className="heading-4 text-white mb-3">Services</h2>
            <p>
          ...
          <div>
            <h2 className="heading-4 text-white mb-3">Estimates and Pricing</h2>
            <p>
          ...
          <div>
            <h2 className="heading-4 text-white mb-3">Scheduling and Inspections</h2>
            <p>
          ...
          <div>
            <h2 className="heading-4 text-white mb-3">Warranty Disclaimer</h2>
            <p>
          ...
          <div>
            <h2 className="heading-4 text-white mb-3">Insurance Claims</h2>
            <p>
          ...
          <div>
            <h2 className="heading-4 text-white mb-3">Website Use</h2>
            <p>
          ...
          <div>
            <h2 className="heading-4 text-white mb-3">Limitation of Liability</h2>
            <p>
          ...
          <div>
            <h2 className="heading-4 text-white mb-3">Contact</h2>
            <p>
